...
(function() {
	...
	optSpecs.push(option_dropImage);
	optSpecs.push(option_pasteImage);
	...
	/* DISABLE DROPPING IMAGES TO UPLOAD */

	function option_dropImage() { }

	option_dropImage.id = 'dropImage';
	option_dropImage.label = 'Disable Drop Upload';
	option_dropImage.type = 'checkbox';
	option_dropImage.tooltip = 'Disables the ability to drop images into the page to upload them';
	option_dropImage.tab = tabs.General;

	/* DISABLE PASTING IMAGES TO UPLOAD */

	function option_pasteImage() { }

	option_pasteImage.id = 'pasteImage';
	option_pasteImage.label = 'Disable Paste Upload';
	option_pasteImage.type = 'checkbox';
	option_pasteImage.tooltip = 'Disables the ability to paste images into the page to upload them';
	option_pasteImage.tab = tabs.General;
