...
Backbone.on('repliedToMe', function (post) {
	...
	if (options.get('beep')) {
		...
		if (!$('#beep').length) {
			...
			$('<audio/>', {id: 'beep', src: beep}).appendTo($('body'));
		}
...
var discoFavicon = 'data:image/vnd.microsoft.icon;base64,AAABAAEAQEAQAAEABABoCgAAFgAAACgAAABAAAAAgAAAAAEABAAAAAAAAAAAAAAAAAAAAAAAAAAA
AAAAAAAAAAAAAAD/AP///wAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
...

